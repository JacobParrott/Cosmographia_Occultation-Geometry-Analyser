...
def iono(ray, dist):
    ...
    # Peak electron density ALTERATION HERE (Mars =2e11)
    N0 = mpf(2.000000000000001e11)
    ...
    for i in range(dist):
        ...
        Ne[0, i] = densitystore
        # convert electron density to refractive index {-k * Ne/f^2}
        N[0, i] = -40.2592397908339 * (Ne[0, i] / 437.1e6 ** 2)
