...
# the results of this is changing for the the number of iterations
...
def ploterrortraces(errorstore, t):
    ...
    ax2.annotate("2)", (0, 0))
    ax3.plot(-1000*errorstore[2, :t-1])
    ax3.axhline(0, c='r', ls='--', lw=.5)
    ax3.annotate("3)", (0, 0))
    ax4.plot(-1000*errorstore[3, :t-1])
    ax4.axhline(0, c='r', ls='--', lw=.5)
    ax4.annotate("4)", (0, 0))
    ax5.plot(-1000*errorstore[4, :t-1])
    ax5.axhline(0, c='r', ls='--', lw=.5)
    ax5.annotate("5)", (0, 0))
    ax6.plot(-1000*errorstore[5, :t-1])
    ax6.axhline(0, c='r', ls='--', lw=.5)
    ax6.annotate("6)", (0, 0))
    ax7.plot(-1000*errorstore[6, :t-1])
    ax7.axhline(0, c='r', ls='--', lw=.5)
    ax7.annotate("7)", (0, 0))
    ax8.plot(-1000*errorstore[7, :t-1])
    ax8.axhline(0, c='r', ls='--', lw=.5)
    ax8.annotate("8)", (0, 0))
    ax9.plot(-1000*errorstore[8, :t-1])
    ax9.axhline(0, c='r', ls='--', lw=.5)
    ax9.annotate("9)", (0, 0))
    ax10.plot(-1000*errorstore[9, :t-1])
    ax10.axhline(0, c='r', ls='--', lw=.5)
    ax10.annotate("10)", (0, 0))
